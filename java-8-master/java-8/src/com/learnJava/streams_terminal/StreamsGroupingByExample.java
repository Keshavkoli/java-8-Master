...
public class StreamsGroupingByExample {
	...
	public static void groupingByGender() {
		...
		Map<String, List<Student>> studentMap = StudentDataBase.getAllStudents().stream()
				.collect(Collectors.groupingBy(Student::getGender));// its going to group the Student based on the
																	// gender
	...
	public static void customizedGroupingBy() {
		...
		// groupingBy this method has a condition where the student greater than 3.8 are OUTSTANDING and less than that are AVERAGE
	...
	public static void twoLevelGrouping_2() {
		...
		Map<String, Integer> nameNoteBooksMap = StudentDataBase.getAllStudents().stream()
				.collect(groupingBy(Student::getName, summingInt(Student::getNoteBooks)));// second argument can be of
	...
	public static void twoLevelGrouping_3() {
		...
		Map<String, Set<Student>> nameNoteBooksMap = StudentDataBase.getAllStudents().stream()
				.collect(groupingBy(Student::getName, toSet()));// second argument can be of any type of collector
