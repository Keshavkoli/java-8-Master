...
public class StreamsPartitioningExample {
	...
	public static void partitioningBy_1() {
		...
		Map<Boolean, List<Student>> studentMap = StudentDataBase.getAllStudents().stream()
				.collect(partitioningBy(gpaPredicate)); // what ever that matches the predicate will be under the true
														// key what ever does not match will be in false key

		System.out.println("studentMap : " + studentMap);

	}
	/* Arguments with two parameter 
	*/
	...
	/* Arguments with three parameter 
	*/
